...
<body>
            ...
            <div class="navbar-header">
                ...
                <a href="/dashboard" class="navbar-brand">
                    <div class="brand-title">
                        <span class="brand-text">K-Move Vancouver</span>
                    </div>
                </a>
            </div>
            <!--================================-->
                        ...
                        <div class="nano-content">
                            ...
                            <div id="mainnav-profile" class="mainnav-profile">
                                <div class="profile-wrap text-center">
                                    <div class="pad-btm">
                                        <img class="img-circle img-md" src="{!! asset('/images/kotra_logo.png') !!}" alt="Kotra Logo">
                                    </div>
                                    <a href="#profile-nav" class="box-block" data-toggle="collapse" aria-expanded="false">
                                        {{--<span class="pull-right dropdown-toggle">--}}
                                            {{--<i class="dropdown-caret"></i>--}}
                                        {{--</span>--}}
                                        <p class="mnp-name">관리자</p>
                                        <span class="mnp-desc">admin@kotra.com</span>
                                    </a>
                                </div>
                            ...
                            <ul id="mainnav-menu" class="list-group">
                                ...
                                <li>
                                    <a href="/dashboard/corporations">
                                        <i class="demo-pli-pen-5"></i>
                                        <span class="menu-title">Corporations</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                    ...
                                    <ul class="collapse">
                                        <li><a href="/dashboard/jobfair_events">Jobfair Events</a></li>
                                        <li><a href="/dashboard/mentorship_events">Mentorship Events</a></li>
                                        <li><a href="/dashboard/seminar_events">Seminar Events</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#">
                                    ...
                                    <ul class="collapse">
                                        <li><a href="/dashboard/mentors">Mentors</a></li>
    ...
    <footer id="footer">
        ...
        <p class="pad-lft">&#0169; 2019 KOTRA Company</p>
    ...
    <script src="{!! asset('dashboard/scripts/scripts.js') !!}"></script>
    <script>
        var DASHBOARD_PATH = "{!! URL::to('/dashboard') !!}";
    </script>
